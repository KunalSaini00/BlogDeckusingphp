...
<?php 
    ...
    $posts = $conn->query("SELECT * FROM posts WHERE status = 1 LIMIT 6");
    $posts->execute();
...
?>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
               ...
               <?php foreach($rows as $row) : ?>
                    ...
                    <div class="post-preview">
                        <a href="http://localhost/Blog-Deck/posts/post.php?post_id=<?php echo $row->id; ?>">
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                ...
                <?php foreach ($category as $cat) : ?>
                        <div class="col-md-6">
                        <a href="http://localhost/Blog-Deck/categories/category.php?cat_id=<?php echo $cat->id; ?>">
