...
<?php 
    ...
    if(isset($_POST['submit']) AND isset($_GET['post_id'])) {
        ...
        if($_POST['comment'] == '') {
            ...
            header("location: http://localhost/Blog-Deck/posts/post.php?post_id=".$id."");
        }
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <?php if(isset($_SESSION['user_id']) AND $_SESSION['user_id'] == $post->user_id) : ?>
                            <a  href="http://localhost/Blog-Deck/posts/delete.php?del_id=<?php echo $post->id; ?>" class="btn btn-danger text-center float-end">Delete</a>
                  ...
                  <form method="POST" action="post.php?post_id=<?php echo $id; ?>">
                    ...
                    <?php else : ?>
                        <div class="bg-danger alert alert-danger text-white">
                           <a href="http://localhost/Blog-Deck/auth/login.php">Login</a> or <a href="http://localhost/Blog-Deck/auth/register.php">Register</a> to comment 
                        </div>
                    <?php endif; ?>       
                </div>
              </div>
